...
/**
 * Provides a form for reverting a Tracking revision.
 *
 * @ingroup ads_tracking
 */
class TrackingRevisionRevertForm extends ConfirmFormBase {
  ...
  public function getFormId() {
    return 'tracking_revision_revert_confirm';
  }
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $this->logger('content')->notice('Tracking: reverted %title revision %revision.', ['%title' => $this->revision->label(), '%revision' => $this->revision->getRevisionId()]);
    $this->messenger()->addMessage(t('Tracking %title has been reverted to the revision from %revision-date.', ['%title' => $this->revision->label(), '%revision-date' => $this->dateFormatter->format($original_revision_timestamp)]));
   ...
   *
   * @param \Drupal\ads_tracking\Entity\TrackingInterface $revision
