...
class StoreLocator extends ContentEntityBase implements StoreLocatorInterface {
  ...
  public static function baseFieldDefinitions(EntityTypeInterface $entity_type) {
    ...
    $fields['name'] = BaseFieldDefinition::create('string')->setLabel(t('Clinic Name'))->setRequired(TRUE)->setDescription(t('Enter the name'))->setSettings([
      'default_value' => '',
      'max_length' => 255,
      'text_processing' => 0,
    ...
    $fields['address_one'] = BaseFieldDefinition::create('string')->setLabel(t('Address'))->setRequired(TRUE)->setDescription(t('Enter the address one detail.'))->setSettings([
      'default_value' => '',
      'max_length' => 255,
      'text_processing' => 0,
    ])->setDisplayOptions('view', [
    ...
    $fields['postcode'] = BaseFieldDefinition::create('string')->setLabel(t('Postcode'))->setRequired(FALSE)->setDescription(t('Enter the postcode'))->setSettings([
      'default_value' => '',
      'max_length' => 20,
      'text_processing' => 0,
    ])->setDisplayOptions('view', [
