...
class DefaultEntityRevisionRevertTranslationForm extends DefaultEntityRevisionRevertForm {
  ...
  public function getFormId() {
    return 'about_revision_revert_translation_confirm';
  }
   ...
   * {@inheritdoc}
   */
  public function buildForm(array $form, FormStateInterface $form_state, $about_revision = NULL, $langcode = NULL) {
    $this->langcode = $langcode;
    $form = parent::buildForm($form, $form_state, $about_revision);
  ...
  protected function prepareRevertedRevision(DefaultEntityInterface $revision, FormStateInterface $form_state) {
    ...
    /** @var \Drupal\about\Entity\DefaultEntityInterface $default_revision */
