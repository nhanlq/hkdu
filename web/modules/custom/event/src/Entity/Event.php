 ...
 *   },
 *   links = {
 *     "canonical" = "/e-pharm/event/{event}",
 *     "add-form" = "/admin/hkdu/event/add",
 *     "edit-form" = "/admin/hkdu/event/{event}/edit",
 *     "delete-form" = "/admin/hkdu/event/{event}/delete",
 *     "version-history" = "/admin/hkdu/event/{event}/revisions",
 *     "revision" = "/admin/hkdu/event/{event}/revisions/{event_revision}/view",
 *     "revision_revert" = "/admin/hkdu/event/{event}/revisions/{event_revision}/revert",
 *     "revision_delete" = "/admin/hkdu/event/{event}/revisions/{event_revision}/delete",
 *     "translation_revert" = "/admin/hkdu/event/{event}/revisions/{event_revision}/revert/{langcode}",
 *     "collection" = "/admin/hkdu/event",
 *   },
...
class Event extends EditorialContentEntityBase implements EventInterface {
  ...
  public function preSave(EntityStorageInterface $storage) {
    ...
    // make the event owner the revision author.
