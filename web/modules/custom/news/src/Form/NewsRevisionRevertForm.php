 ...
 * @ingroup news
 */
class NewsRevisionRevertForm extends ConfirmFormBase {
  ...
  public function getFormId() {
    return 'news_revision_revert_confirm';
  }
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $this->messenger()->addMessage(t('News %title has been reverted to the revision from %revision-date.', ['%title' => $this->revision->label(), '%revision-date' => $this->dateFormatter->format($original_revision_timestamp)]));
   ...
   *
   * @param \Drupal\news\Entity\NewsInterface $revision
