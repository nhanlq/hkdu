...
class PaymentController extends ControllerBase {
  ...
  public function action() {
    ...
    if(isset($_POST['type']) && $_POST['type']=='upload'){
      $redirect = new RedirectResponse(\Drupal\Core\Url::fromUserInput('/payment/upload/receipt/'.$product_id)->toString());;
      $redirect->send();
    }else{
      $redirect = new RedirectResponse(\Drupal\Core\Url::fromUserInput('/e-pharm/addcart/'.$product_id)->toString());;
      $redirect->send();
    }
  ...
  public function approval($id) {
    ...
    $user = \Drupal\user\Entity\User::load($payment->get('field_user')
      ->target_id);
    ...
    $redirect = new RedirectResponse(\Drupal\Core\Url::fromUserInput('/admin/hkdu/payment_upload/'.$payment->id())->toString());;
    $redirect->send();
    return [
      '#type' => 'markup',
